...
With hands-on experience in C#/.NET Core, FastAPI, TypeScript, and React, I design solutions that are both robust and user-centric. My work spans domains like finance and real estate, where I've built APIs, optimized databases, and delivered features that turn complex data into actionable business insights.

I'm equally passionate about Data Science & AI — I love cleaning messy datasets, performing exploratory analysis, building machine learning models, and uncovering patterns that drive better decisions.
